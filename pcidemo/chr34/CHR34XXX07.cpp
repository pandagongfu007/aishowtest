...
void CHR34xxx_RecvData(BYTE ChNum, bool is_IntRecv, bool is_asynPtRecv,
                       bool is_syncMode, bool is_FreshRecv, BYTE* Rxbuf, DWORD* dwResult);
...
void initApiParam()
{
	...
	//接收协议
	m_ptCGF.PtRxMode = 1;//接收模式(0:FIFO接收,1:刷新接收)
