...
DLL BOOL __stdcall _CHR34XXX_GetSN(IN int devId,int SNType,DWORD *dwSN);
DLL BOOL __stdcall _CHR34XXX_SetSN(IN int devId,int SNType,DWORD *dwSN);
DLL BOOL __stdcall _CHR34XXX_GetDevInf(IN int devId,WORD *dwDevInf);
DLL BOOL __stdcall _CHR34XXX_SetDevInf(IN int devId,WORD *dwDevInf);

DLL BOOL __stdcall CHR34XXX_SetDMADeepth(IN int devId,IN BYTE Channel,IN DWORD DMADeepth);    //设置dma触发深度
